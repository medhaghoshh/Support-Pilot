...
SAMPLE_TICKETS = [
    ...
    # cluster 1: mobile device / email-on-phone setup
    ...
    # cluster 2: specific software crashes
    ...
    # cluster 3: HR / account-lifecycle topics
    ...
    # Previously-flagged gaps, now covered after adding KB-116 and KB-117
